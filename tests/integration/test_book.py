...
def test_not_possible_to_book_more_than_points_available(client, mocker):
    ...
    # création d'un club avec un nombre de places faible :
    fake_club = [
        {
            "name": "Simply Lift",
...
def test_not_possible_to_book_more_than_places_available(client, mocker):
    ...
    # création d'une compétation avec un nombre de places faible :
    fake_competition = [
        {
    ...
    # remplacement des données clubs, car elles ont pu être modifiées en dur par les précédents
    # tests ce qui fait choué le test quanf il n'est pas lancé individuelement.
    fake_clubs = [
        {
            "name": "Simply Lift",
            "email": "john@simplylift.co",
    ...
    # remplacement des données du json par ces compétitions modifiées
